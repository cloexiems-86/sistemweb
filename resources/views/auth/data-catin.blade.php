...
<head>
    ...
    <title>Data Catin - KUA Mojo Admin</title>
        ...
        <aside class="w-72 bg-white dark:bg-[#1a2b15] border-r border-[#dee5dc] dark:border-white/10 flex flex-col h-full">
            <div class="p-6 flex flex-col gap-6">
                ...
                <nav class="flex flex-col gap-1">
                    ...
                    <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-[#131811] dark:text-white/80 hover:bg-[#f1f4f0] dark:hover:bg-white/5 transition-colors" href="/materi">
                        <span class="material-symbols-outlined">auto_stories</span>
                        <span class="text-sm">Materi Edukasi</span>
                    </a>
                    <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-[#131811] dark:text-white/80 hover:bg-[#f1f4f0] dark:hover:bg-white/5 transition-colors" href="/jadwal">
                        <span class="material-symbols-outlined">calendar_today</span>
                        <span class="text-sm">Jadwal Bimbingan</span>
                    </a>
                    <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-[#131811] dark:text-white/80 hover:bg-[#f1f4f0] dark:hover:bg-white/5 transition-colors" href="/settings">
        ...
        <main class="flex-1 flex flex-col overflow-y-auto">
            <header class="sticky top-0 z-10 bg-white/80 dark:bg-[#1a2b15]/80 backdrop-blur-md border-b border-[#dee5dc] dark:border-white/10 px-8 py-4 flex items-center justify-between">
                <div class="flex items-center gap-6">
                    <h2 class="text-[#131811] dark:text-white text-xl font-bold tracking-tight">Data Calon Pengantin</h2>
                    <div class="relative w-72">
                        <span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#6c8863] text-lg">search</span>
                        <input class="w-full h-10 pl-10 pr-4 bg-[#f1f4f0] dark:bg-white/5 border-none rounded-lg text-sm focus:ring-2 focus:ring-primary/50 dark:placeholder-white/40" placeholder="Cari nama catin..." type="text"/>
                    </div>
                </div>
            ...
            <div class="p-8">
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                    <div>
                        <h1 class="text-3xl font-black tracking-tight">Manajemen Data Catin</h1>
                        <p class="text-[#6c8863] dark:text-white/60">Kelola dan pantau seluruh akun calon pengantin untuk bimbingan pra-nikah.</p>
                    </div>
                    <a 
                        href="{{ route('admin.catin.create') }}" class="flex items-center gap-2 px-5 py-2.5 bg-primary text-[#131811] font-bold rounded-lg shadow-lg shadow-primary/20 transition-all active:scale-95">
                        <span class="material-symbols-outlined text-lg">person_add</span>
                        <span>Tambah Akun Catin</span>
                    </a>
                </div>
                ...
                <div class="bg-white dark:bg-[#1a2b15] rounded-xl border border-[#dee5dc] dark:border-white/10 overflow-hidden shadow-sm mb-8">
                    <div class="flex flex-col md:flex-row md:items-center justify-between p-4 gap-4 border-b border-[#dee5dc] dark:border-white/10">
                        <div class="flex gap-4">
                            <button class="px-4 py-2 border-b-2 border-primary text-primary font-bold text-sm">Semua Catin</button>
                            <button class="px-4 py-2 text-[#6c8863] dark:text-white/60 font-medium text-sm hover:text-primary">Aktif</button>
                            <button class="px-4 py-2 text-[#6c8863] dark:text-white/60 font-medium text-sm hover:text-primary">Nonaktif</button>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-[#dee5dc] dark:divide-white/10">
                                <tr class="hover:bg-background-light dark:hover:bg-white/5 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">AS</div>
                                            <span class="font-semibold dark:text-white">Ahmad Sulaiman</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-[#6c8863] dark:text-white/60">@ahmad_sulaiman</td>
                                    <td class="px-6 py-4">
                                        <span class="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full text-[10px] font-bold uppercase">Catin</span>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="hover:bg-background-light dark:hover:bg-white/5 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center text-rose-600 font-bold text-xs">BK</div>
                                            <span class="font-semibold dark:text-white">Budi Kusuma</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-[#6c8863] dark:text-white/60">@budi_ksm</td>
                                    <td class="px-6 py-4">
                                        <span class="px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 rounded-full text-[10px] font-bold uppercase">Catin</span>
                                    </td>
                                    <td class="px-6 py-4">
                    ...
                    <div class="p-4 border-t border-[#dee5dc] dark:border-white/10 flex items-center justify-between">
                        <p class="text-xs text-[#6c8863] dark:text-white/60">Menampilkan 1 sampai 2 dari 1,240 entri</p>
                        <div class="flex gap-1">
                            <button class="p-2 border border-[#dee5dc] dark:border-white/10 rounded hover:bg-gray-50 dark:hover:bg-white/5"><span class="material-symbols-outlined text-sm dark:text-white">chevron_left</span></button>
                            ...
                            <button class="p-2 border border-[#dee5dc] dark:border-white/10 rounded hover:bg-gray-50 dark:hover:bg-white/5"><span class="material-symbols-outlined text-sm dark:text-white">chevron_right</span></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white dark:bg-[#1a2b15] p-5 rounded-xl border border-[#dee5dc] dark:border-white/10 flex items-center gap-4 shadow-sm">
                        <div class="size-12 rounded-lg bg-primary/20 flex items-center justify-center text-primary"><span class="material-symbols-outlined text-3xl">groups</span></div>
                        <div><p class="text-sm text-[#6c8863] dark:text-white/60">Total Akun Catin</p><p class="text-2xl font-black dark:text-white">1,240</p></div>
                    </div>
                    <div class="bg-white dark:bg-[#1a2b15] p-5 rounded-xl border border-[#dee5dc] dark:border-white/10 flex items-center gap-4 shadow-sm">
                        <div class="size-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-blue-600"><span class="material-symbols-outlined text-3xl">favorite</span></div>
                        <div><p class="text-sm text-[#6c8863] dark:text-white/60">Pasangan Aktif</p><p class="text-2xl font-black dark:text-white">582</p></div>
                    </div>
                    <div class="bg-white dark:bg-[#1a2b15] p-5 rounded-xl border border-[#dee5dc] dark:border-white/10 flex items-center gap-4 shadow-sm">
                        <div class="size-12 rounded-lg bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center text-amber-600"><span class="material-symbols-outlined text-3xl">verified_user</span></div>
                        <div><p class="text-sm text-[#6c8863] dark:text-white/60">Terverifikasi</p><p class="text-2xl font-black dark:text-white">1,120</p></div>
                    </div>
                </div>
            </div>
